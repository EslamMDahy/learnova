...
class ModulesApi {
  ...
  /// no request body is needed or read by the server.
  ///
  /// [sourceCourseId] is kept in the signature for call-site clarity only;
  /// it is NOT sent in the request.
  /// [targetCourseId] goes in the URL path as course_id.
